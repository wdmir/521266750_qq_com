...
package net.wdqipai.core.model.level2
{
	...
	public class UserModelByCom implements IUserModel
	{					
		...
		public function UserModelByCom(id_:String,
								  	   sex_:String,
								  	   nickName_:String,
								  	   bbs_:String,
									   isAdmin_:Boolean)
		...
		{
			var u:UserModelByCom = new UserModelByCom(
								   ...
								   ):String
		{
			...
			_headIco = QiPaiIco.getHeadPhotoPath(
													selectDB_Mode,
													this.id_sql,
													rootUrl,
													installDir,
