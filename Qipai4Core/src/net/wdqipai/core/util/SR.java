...
public static String getGame_svr_failed_help()
{
	if (zh_CN.equals(Lang))
	{
		return "\n如需帮助，请访问作者网站：www.wdmir.net ,技术支持网站：www.wdqipai.net";
	}

	if (zh_TW.equals(Lang) || zh_HK.equals(Lang) || zh_MO.equals(Lang) || zh_SG.equals(Lang))
	{
		return "\n如需幫助，請訪問作者網站：www.wdmir.net ,技術支持網站：www.wdqipai.net";
	}

	return "\n For assistance, please visit the author website: www.wdmir.net, technical support website: www.wdqipai.net";
}
