...
import net.wdqipai.core.db.MsSqlDB;
import net.wdqipai.core.db.MySqlDB;
import net.wdqipai.core.db.SqlLiteDB;
...
import net.wdqipai.core.util.TimeUtil;
import net.wdqipai.core.db.DBTypeModel;
import net.wdqipai.core.model.IUserModelByDB;
import net.wdqipai.core.util.JSON;
import net.wdqipai.core.util.MD5ByJava;
import net.wdqipai.server.extmodel.MembershipCreateStatus;
import net.wdqipai.server.extmodel.MembershipLoginStatus;
	...
	*/
	...
	public static String getProof()
	{
                ...
                String tableHonor_,String TableUsers) throws ClassNotFoundException, SQLException
        {
                ...
                //
                RCLogic.TableUsers = "wdqipai_" + TableUsers;

                //
                RCLogic.TableLog = "wdqipai_" + String.valueOf(LocalDate.now().getYear()) + "_" + tableLog_;
                RCLogic.autoClearTableLog = autoClearTableLog_;
                RCLogic.TableEveryDayLogin = "wdqipai_" + String.valueOf(LocalDate.now().getYear())+ "_" + tableEveryDayLogin_;
                RCLogic.autoClearTableEveryDayLogin = autoClearTableEveryDayLogin_;
                RCLogic.TableHonor = "wdqipai_" + tableHonor_;
                RCLogic.TableLvl = "wdqipai_level";
                RCLogic.TableLvlName = "wdqipai_level_name";
                ...
                if (RCLogic.selectDB.sql.toLowerCase().equals("mysql"))
                {
                        ...
                        if (RCLogicC.createMySqlTable(engine)[0].equals("False"))
                        {
                                return initOk;
                        }
                ...
                else if (RCLogic.selectDB.sql.toLowerCase().equals("sqlite"))
                {
                        //
                        SqlLiteDB.connectionString = RCLogic.selectDB.getPath();

                        testLiteSqlConnection();
                        RCLogicC.createLiteSqlTable();
                }
    ...
    */
    public static void doorReg(AppSession session, XmlDocument doc)
    {
            try
            {
                ...
                else if (DBTypeModel.PW.equals(DBTypeModel.PW))
                {
                ...
                else if(DBTypeModel.X.equals(DBTypeModel.X))
                {
...
//                }
            ...
            try
            {
                    ...
                    if (nowG64 >= total)
                    {
                            ...
                            for (i = 0; i < len; i++)
                            {
                                    ...
                                    dbUpdG(n, id, type, String.valueOf(g), Integer.parseInt(roomId), gamename);
            ...
            try
            {
                    ...
                    for (int i = 0; i < len; i++)
                    {
                        ...
                        for (int j = 0; j < id.length; j++)
                        {
                                if (!id[j].equals(""))
                                {
                                    dbUpdG(n[j], id[j], type, g[j], Integer.parseInt(roomId), gamename);
                                }
                        }
            ...
            try
            {
                    ...
                    for (int i = 0; i < len; i++)
                    {
                            ...
                            for (int j = 0; j < id.length; j++)
                            {
                                    if (!id[j].equals(""))
                                    {
                                            dbUpdHonor(n[j], id[j], type, g[j], Integer.parseInt(roomId), gamename);
                                    }
                            }
                    } //end for
            }
                ...
                for (int i = 0; i < len; i++)
                {
                       ...
                       node.ChildNodes()[i].setAttribute(edlAttr);
                        ...
                        else
                        {
                                ...
                                //
                                dbUpdG(username, id, "add", gv, roomId, gn);
        ...
        try
            {
                    ...
                    String k = gn + "_" + String.valueOf(LocalTime.now().getHour());//如果有请求,每小时更新一次
    ...
    */
    ...
    /** 
     ...
     @param gamename
    */
    public static void dbUpdHonor(String username, String id, String type, String gChangeValue, int roomId, String gamename)
    {
    ...
    /** 
     ...
     @param gValue
    */
    public static void dbUpdG(String username, String id, String type, String gChangeValue, int roomId, String gamename) throws SQLException, ClassNotFoundException
    {
        ...
        else if (RCLogic.selectDB.sql.toLowerCase().equals("mysql"))
        {
                ...
                WriteDBByMySqlRecv(RCLogic.TableLog, "mysql update", String.valueOf(count), DZ_Cloumn, type + ":" + gChangeValue, String.valueOf(g64), username, roomId, gamename);
    ...
    public static DataSet dbGetTopList(String gamename) throws SQLException, ClassNotFoundException
    {
       ...
       DataSet ds = null;
        ...
        if (RCLogic.selectDB.sql.toLowerCase().equals("mysql"))
        {
            ...
            String sql = "SELECT sum( p1B ) AS total_p1B,n FROM `" + RCLogic.TableLog + "` where p1A ='" + "add" +                    
...
//            }
    ...
    public static void WriteDBByMySqlRecv(String tbl_name, String actionStr, String rowCount, String cloumn, String param1, String param2, String username, int roomId, String gamename)
    {
        try
        {
                ...
                insertSql.append(" (game,room,t1,t2,t,a,line_n,c,p1A,p1B,p2,n) ");
