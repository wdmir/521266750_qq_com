...
namespace net.silverfoxserver.core.socket
{
    ...
    public class SocketAcceptorSync
    {
        ...
        protected void Event_SessionClosed(AppSession c, CloseReason reason)
        {
            ...
            {
                Log.WriteStrByException("SocketAcceptorSync", "Event_SessionClosed", exd.Message, exd.Source, exd.StackTrace);
        ...
        protected void Event_NewSessionConnected(AppSession c)
        {
            ...
            {
                Log.WriteStrByException("SocketAcceptorSync", "Event_NewSessionConnected", exd.Message, exd.Source, exd.StackTrace);
            }
        }
        ...
        protected void Event_NewRequestReceived(AppSession c, StringRequestInfo info)
        {
            ...
            {
                Log.WriteStrByException("SocketAcceptorSync", "Event_NewRequestReceived", exd.Message, exd.Source, exd.StackTrace);
            }
        }
