...
namespace SuperSocket.SocketBase.Config
{
    ...
    public class ServerConfig : IServerConfig
    {
        ...
        /// </summary>
        public const int DefaultReceiveBufferSize = 8192;//4096;

        /// <summary>
        /// Default MaxConnectionNumber
        /// </summary>
        public const int DefaultMaxConnectionNumber = 1001;//3000;//100
        ...
        /// </summary>
        public const int DefaultMaxRequestLength = 8192;//1024 * 2;
        ...
        public ServerConfig()
        {
            ...
            KeepAliveTime = 30 * 60;// 30 minutes
            KeepAliveInterval = 60;// 60 seconds
            ListenBacklog = 50;//100;
